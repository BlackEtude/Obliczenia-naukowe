...
\section{Zadanie 6}
	...
	\subsection{Wnioski}
		...
		\begin{figure}[!htbp]
			\centering
			\subfloat[1.][Eksperyment 3]{\includegraphics[width=0.5\textwidth]{zad6/plot3.png}} \hfill
			\subfloat[2.][Eksperyment 6]{\includegraphics[width=0.5\textwidth]{zad6/plot6.png}} \hfill
			\subfloat[3.][Eksperyment 7]{\includegraphics[width=0.5\textwidth]{zad6/plot7.png}}
  			\caption{Zestawienie wyników iteracji dla wybranych przypadków}
  			\label{fig:7}
		\end{figure}	
\end{document}
